...
# 1. Login V10: Fixed Toggle, Rich Purple Color
...
if start_idx != -1 and end_idx != -1:
    print(f"Replacing Login V10 at lines {start_idx+1}-{end_idx}")
    ...
    print("SUCCESS: Login Page Refined V10 (Toggle Fix & Rich Purple).")
else:
